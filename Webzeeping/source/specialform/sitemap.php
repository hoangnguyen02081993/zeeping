...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
    <url>
        <loc>https://www.zeeping.com/</loc>
        <lastmod>2017-03-01</lastmod>
        <changefreq>weekly</changefreq>
        <priority>0.9</priority>
    </url>
    <url>
        <loc>https://www.zeeping.com/FAQ</loc>
        <lastmod>2017-08-20</lastmod>
        <changefreq>weekly</changefreq>
        <priority>0.7</priority>
    </url>
    <url>
        <loc>https://zeeping.com/customer/support.php</loc>
        <lastmod>2017-07-19</lastmod>
        <changefreq>weekly</changefreq>
        <priority>0.8</priority>
    </url>
    <url>
        <loc>https://zeeping.com/customer/login.php</loc>
    ...
    <?php
        ...
        {
            echo '<url>
                <loc>https://www.zeeping.com/' . $Menu["link"] .'/</loc>
                <lastmod>2017-03-01</lastmod>
        ...
        {
            echo '<url>
                <loc>https://www.zeeping.com/' . $Product["linkProduct"] .'/</loc>
