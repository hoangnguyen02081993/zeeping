...
<head>
    ...
    if(isset($_POST["submit"]))
    {
        ...
        CheckAndUpdateInforgot($_POST["username"], $_POST["password"]);
...
<body class="login-layout  body-login">
					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							...
							<div class="position-relative">
												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input id="login__username" type="text" class="form-control" name="username" placeholder="Username">
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input id="login__password" type="password" class="form-control" name="password" placeholder="Password">
													...
													<div class="clearfix">
														...
														<button id="btn_submit" type="submit" name="submit" class="width-35 pull-right btn btn-sm btn-primary">
								...
								<div id="forgot-box" class="forgot-box widget-box no-border" style="background-color:#d0d0d0">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form name="frmforgot" onsubmit="return onForgotSubmit();">
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input id="emailforgot" type="email" name="email" class="form-control" placeholder="Email" required>
															<i class="ace-icon fa fa-envelope"></i>
														</span>
													</label>

													<div class="clearfix">
														<button id="btn_forgot" type="submit" name="submit" class="width-35 pull-right btn btn-sm btn-danger">
		...
		function onForgotSubmit()
		{
            ...
            function(data, status){
                function postRefreshPage () {
                  ...
                  theForm.action = "./forgotsuccess.php";
                  theForm.method = "post";
                  inputg = document.createElement("input");
                  inputg.type = "hidden";
                  inputg.name = "user";
                  inputg.value = $("#emailforgot")[0].value;
